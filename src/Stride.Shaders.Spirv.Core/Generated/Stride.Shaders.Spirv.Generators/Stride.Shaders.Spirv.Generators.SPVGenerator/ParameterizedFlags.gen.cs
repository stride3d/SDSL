...
public static class ParameterizedFlags
{
    ...
    public static ParameterizedFlag<Decoration> DecorationLinkIdSDSL(int linkidsdsl_idRef0) => new ParameterizedFlag<Decoration>(Decoration.LinkIdSDSL, [linkidsdsl_idRef0]);
    ...
    public static ParameterizedFlag<Decoration> DecorationSamplerStateFilter(SamplerFilterSDSL samplerstatefilter_samplerfiltersdsl0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateFilter, [(int)samplerstatefilter_samplerfiltersdsl0]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateAddressU(SamplerTextureAddressModeSDSL samplerstateaddressu_samplertextureaddressmodesdsl0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateAddressU, [(int)samplerstateaddressu_samplertextureaddressmodesdsl0]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateAddressV(SamplerTextureAddressModeSDSL samplerstateaddressv_samplertextureaddressmodesdsl0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateAddressV, [(int)samplerstateaddressv_samplertextureaddressmodesdsl0]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateAddressW(SamplerTextureAddressModeSDSL samplerstateaddressw_samplertextureaddressmodesdsl0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateAddressW, [(int)samplerstateaddressw_samplertextureaddressmodesdsl0]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateMipLODBias(string samplerstatemiplodbias_literalstring0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateMipLODBias, [..samplerstatemiplodbias_literalstring0.AsDisposableLiteralValue().Words]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateMaxAnisotropy(int samplerstatemaxanisotropy_literalinteger0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateMaxAnisotropy, [samplerstatemaxanisotropy_literalinteger0]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateComparisonFunc(SamplerComparisonFuncSDSL samplerstatecomparisonfunc_samplercomparisonfuncsdsl0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateComparisonFunc, [(int)samplerstatecomparisonfunc_samplercomparisonfuncsdsl0]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateMinLOD(string samplerstateminlod_literalstring0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateMinLOD, [..samplerstateminlod_literalstring0.AsDisposableLiteralValue().Words]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateMaxLOD(string samplerstatemaxlod_literalstring0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateMaxLOD, [..samplerstatemaxlod_literalstring0.AsDisposableLiteralValue().Words]);
    ...
    public static ParameterizedFlag<Decoration> DecorationBuiltIn(BuiltIn builtin_builtin0) => new ParameterizedFlag<Decoration>(Decoration.BuiltIn, [(int)builtin_builtin0]);
    ...
    public static ParameterizedFlag<Decoration> DecorationImplementInRegisterMapINTEL(int implementinregistermapintelParameter0) => new ParameterizedFlag<Decoration>(Decoration.ImplementInRegisterMapINTEL, [implementinregistermapintelParameter0]);
    ...
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsBias(int bias_idRef0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.Bias, [bias_idRef0]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsLod(int lod_idRef0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.Lod, [lod_idRef0]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsGrad(int grad_idRef0, int grad_idRef1) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.Grad, [grad_idRef0, grad_idRef1]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsConstOffset(int constoffset_idRef0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.ConstOffset, [constoffset_idRef0]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsOffset(int offset_idRef0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.Offset, [offset_idRef0]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsConstOffsets(int constoffsets_idRef0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.ConstOffsets, [constoffsets_idRef0]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsSample(int sample_idRef0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.Sample, [sample_idRef0]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsMinLod(int minlod_idRef0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.MinLod, [minlod_idRef0]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsMakeTexelAvailable(int maketexelavailable_idscope0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.MakeTexelAvailable, [maketexelavailable_idscope0]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsMakeTexelVisible(int maketexelvisible_idscope0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.MakeTexelVisible, [maketexelvisible_idscope0]);
    public static ParameterizedFlag<ImageOperandsMask> ImageOperandsOffsets(int offsets_idRef0) => new ParameterizedFlag<ImageOperandsMask>(ImageOperandsMask.Offsets, [offsets_idRef0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlDependencyLength(int dependencylength_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.DependencyLength, [dependencylength_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlMinIterations(int miniterations_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.MinIterations, [miniterations_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlMaxIterations(int maxiterations_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.MaxIterations, [maxiterations_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlIterationMultiple(int iterationmultiple_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.IterationMultiple, [iterationmultiple_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlPeelCount(int peelcount_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.PeelCount, [peelcount_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlPartialCount(int partialcount_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.PartialCount, [partialcount_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlInitiationIntervalINTEL(int initiationintervalintel_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.InitiationIntervalINTEL, [initiationintervalintel_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlMaxConcurrencyINTEL(int maxconcurrencyintel_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.MaxConcurrencyINTEL, [maxconcurrencyintel_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlDependencyArrayINTEL(int dependencyarrayintel_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.DependencyArrayINTEL, [dependencyarrayintel_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlPipelineEnableINTEL(int pipelineenableintel_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.PipelineEnableINTEL, [pipelineenableintel_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlLoopCoalesceINTEL(int loopcoalesceintel_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.LoopCoalesceINTEL, [loopcoalesceintel_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlMaxInterleavingINTEL(int maxinterleavingintel_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.MaxInterleavingINTEL, [maxinterleavingintel_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlSpeculatedIterationsINTEL(int speculatediterationsintel_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.SpeculatedIterationsINTEL, [speculatediterationsintel_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlLoopCountINTEL(int loopcountintel_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.LoopCountINTEL, [loopcountintel_literalinteger0]);
    public static ParameterizedFlag<LoopControlMask> LoopControlMaxReinvocationDelayINTEL(int maxreinvocationdelayintel_literalinteger0) => new ParameterizedFlag<LoopControlMask>(LoopControlMask.MaxReinvocationDelayINTEL, [maxreinvocationdelayintel_literalinteger0]);
    public static ParameterizedFlag<MemoryAccessMask> MemoryAccessAligned(int aligned_literalinteger0) => new ParameterizedFlag<MemoryAccessMask>(MemoryAccessMask.Aligned, [aligned_literalinteger0]);
    public static ParameterizedFlag<MemoryAccessMask> MemoryAccessMakePointerAvailable(int makepointeravailable_idscope0) => new ParameterizedFlag<MemoryAccessMask>(MemoryAccessMask.MakePointerAvailable, [makepointeravailable_idscope0]);
    public static ParameterizedFlag<MemoryAccessMask> MemoryAccessMakePointerVisible(int makepointervisible_idscope0) => new ParameterizedFlag<MemoryAccessMask>(MemoryAccessMask.MakePointerVisible, [makepointervisible_idscope0]);
    public static ParameterizedFlag<MemoryAccessMask> MemoryAccessAliasScopeINTELMask(int aliasscopeintelmask_idRef0) => new ParameterizedFlag<MemoryAccessMask>(MemoryAccessMask.AliasScopeINTELMask, [aliasscopeintelmask_idRef0]);
    public static ParameterizedFlag<MemoryAccessMask> MemoryAccessNoAliasINTELMask(int noaliasintelmask_idRef0) => new ParameterizedFlag<MemoryAccessMask>(MemoryAccessMask.NoAliasINTELMask, [noaliasintelmask_idRef0]);
    ...
    public static ParameterizedFlag<TensorAddressingOperandsMask> TensorAddressingOperandsTensorView(int tensorview_idRef0) => new ParameterizedFlag<TensorAddressingOperandsMask>(TensorAddressingOperandsMask.TensorView, [tensorview_idRef0]);
    public static ParameterizedFlag<TensorAddressingOperandsMask> TensorAddressingOperandsDecodeFunc(int decodefunc_idRef0) => new ParameterizedFlag<TensorAddressingOperandsMask>(TensorAddressingOperandsMask.DecodeFunc, [decodefunc_idRef0]);
}