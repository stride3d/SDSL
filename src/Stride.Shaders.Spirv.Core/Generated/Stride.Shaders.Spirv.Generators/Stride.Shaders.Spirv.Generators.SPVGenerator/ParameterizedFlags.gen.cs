...
public static class ParameterizedFlags
{
    ...
    public static ParameterizedFlag<Decoration> DecorationSamplerStateAddressV(SamplerTextureAddressModeSDSL samplertextureaddressmodesdsl0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateAddressV, [(int)samplertextureaddressmodesdsl0]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateAddressW(SamplerTextureAddressModeSDSL samplertextureaddressmodesdsl0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateAddressW, [(int)samplertextureaddressmodesdsl0]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateMipLODBias(string literalstring0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateMipLODBias, [..literalstring0.AsDisposableLiteralValue().Words]);
    public static ParameterizedFlag<Decoration> DecorationSamplerStateMaxAnisotropy(int literalinteger0) => new ParameterizedFlag<Decoration>(Decoration.SamplerStateMaxAnisotropy, [literalinteger0]);
