...
public enum SDSLOp : int
{
    OpSDSLShader = 6430,
    OpSDSLShaderEnd = 6431,
    OpSDSLEffect = 6432,
    OpSDSLComposition = 6433,
    OpSDSLCompositionEnd = 6434,
    OpSDSLMixinInherit = 6435,
    OpSDSLCompose = 6436,
    OpSDSLStage = 6437,
    OpSDSLImportShader = 6438,
    OpSDSLImportFunction = 6439,
    OpSDSLImportVariable = 6440,
    OpSDSLImportStruct = 6441,
    OpVariableSDSL = 6442,
    OpMemberAccessSDSL = 6443,
    OpTypeFunctionSDSL = 6444,
    OpSDSLFunctionInfo = 6445,
    OpBaseSDSL = 6446,
    OpThisSDSL = 6447,
    OpStageSDSL = 6448,
    OpStreamsSDSL = 6449,
    OpSDSLMixin = 6450,
    OpSDSLMixinCompose = 6451,
    OpSDSLMixinComposeArray = 6452,
    OpSDSLGenericParameter = 6453,
    OpSDSLGenericReference = 6454,
    OpConstantStringSDSL = 6455,
    OpTypeGenericSDSL = 6456,
    OpTypeStreamsSDSL = 6457,
    OpForeachSDSL = 6458,
    OpForeachEndSDSL = 6459,
    OpUnresolvableShaderSDSL = 6460,
    OpNop = 0,
    OpUndef = 1,
    OpSourceContinued = 2,
    OpSource = 3,
