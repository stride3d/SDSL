...
public enum SDSLOp : int
{
    ...
    OpSDSLEffect = 6432,
    OpSDSLEffectEnd = 6433,
    OpSDSLMixinInherit = 6434,
    OpSDSLCompose = 6435,
    OpSDSLStage = 6436,
    OpSDSLImportShader = 6437,
    OpSDSLImportFunction = 6438,
    OpSDSLImportVariable = 6439,
    OpSDSLImportStruct = 6440,
    OpMemberAccessSDSL = 6441,
    OpSDSLFunctionInfo = 6442,
    OpBaseSDSL = 6443,
    OpThisSDSL = 6444,
    OpStageSDSL = 6445,
    OpSDSLMixin = 6446,
    OpSDSLMixinCompose = 6447,
    OpSDSLMixinComposeArray = 6448,
    OpSDSLGenericParameter = 6449,
    OpConstantStringSDSL = 6450,
    OpTypeGenericLinkSDSL = 6451,
    OpForeachSDSL = 6452,
    OpForeachEndSDSL = 6453,
    OpNop = 0,
    OpUndef = 1,
    OpSourceContinued = 2,
    OpSource = 3,
