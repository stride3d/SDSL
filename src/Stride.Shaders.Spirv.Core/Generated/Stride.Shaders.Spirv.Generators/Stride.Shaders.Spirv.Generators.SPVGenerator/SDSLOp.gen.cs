...
public enum SDSLOp : int
{
    ...
    OpVariableSDSL = 6441,
    OpMemberAccessSDSL = 6442,
    OpSDSLFunctionInfo = 6443,
    OpBaseSDSL = 6444,
    OpThisSDSL = 6445,
    OpStageSDSL = 6446,
    OpSDSLMixin = 6447,
    OpSDSLMixinCompose = 6448,
    OpSDSLMixinComposeArray = 6449,
    OpSDSLGenericParameter = 6450,
    OpConstantStringSDSL = 6451,
    OpTypeGenericLinkSDSL = 6452,
    OpForeachSDSL = 6453,
    OpForeachEndSDSL = 6454,
    OpNop = 0,
    OpUndef = 1,
    OpSourceContinued = 2,
    OpSource = 3,
