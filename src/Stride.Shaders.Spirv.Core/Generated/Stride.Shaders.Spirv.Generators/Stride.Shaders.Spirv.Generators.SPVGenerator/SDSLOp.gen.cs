...
public enum SDSLOp : int
{
    ...
    OpStageSDSL = 6448,
    OpSDSLMixin = 6449,
    OpSDSLMixinCompose = 6450,
    OpSDSLMixinComposeArray = 6451,
    OpSDSLGenericParameter = 6452,
    OpSDSLGenericReference = 6453,
    OpConstantStringSDSL = 6454,
    OpTypeGenericSDSL = 6455,
    OpForeachSDSL = 6456,
    OpForeachEndSDSL = 6457,
    OpUnresolvableShaderSDSL = 6458,
    OpNop = 0,
    OpUndef = 1,
    OpSourceContinued = 2,
    OpSource = 3,
