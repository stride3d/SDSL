...
public static partial class Specification
{
    ...
    public enum LiteralInteger
    {
    }

    public enum LiteralString
    {
    }

    public enum LiteralFloat
    {
    }

    public enum LiteralContextDependentNumber
    {
    }

    public enum LiteralExtInstInteger
    {
    }

    public enum LiteralSpecConstantOpInteger
    {
    }

    public enum PairLiteralIntegerIdRef
    {
    }

    public enum PairIdRefLiteralInteger
    {
    }

    public enum PairIdRefIdRef
    {
    }
}