...
public static partial class Specification
{
    ...
    {
        OpSDSLShader = 8000,
        OpSDSLShaderEnd = 8001,
        OpSDSLComposition = 8002,
        OpSDSLCompositionEnd = 8003,
        OpSDSLMixinInherit = 8004,
        OpSDSLCompose = 8005,
        OpSDSLStage = 8006,
        OpSDSLImportShader = 8007,
        OpSDSLImportFunction = 8008,
        OpSDSLImportVariable = 8009,
        OpSDSLImportStruct = 8010,
        OpVariableSDSL = 8011,
        OpMemberAccessSDSL = 8012,
        OpTypeFunctionSDSL = 8013,
        OpSDSLFunctionInfo = 8014,
        OpBaseSDSL = 8015,
        OpThisSDSL = 8016,
        OpStageSDSL = 8017,
        OpStreamsSDSL = 8018,
        OpSDSLGenericParameter = 8019,
        OpSDSLGenericReference = 8020,
        OpConstantStringSDSL = 8021,
        OpTypeGenericSDSL = 8022,
        OpTypeStreamsSDSL = 8023,
        OpTypeGeometryStreamOutputSDSL = 8024,
        OpTypePatchSDSL = 8025,
        OpForeachSDSL = 8026,
        OpForeachEndSDSL = 8027,
        OpUnresolvableShaderSDSL = 8028,
        OpEmitVertexSDSL = 8029,
        OpEffectSDFX = 9000,
        OpParamsUseSDFX = 9001,
        OpParamsSDFX = 9002,
        OpParamsFieldSDFX = 9003,
        OpMixinSDFX = 9004,
        OpNop = 0,
        OpUndef = 1,
        OpSourceContinued = 2,
