...
public static partial class Specification
{
    ...
    {
        OpSDSLShader = 6430,
        OpSDSLShaderEnd = 6431,
        OpSDSLEffect = 6432,
        OpSDSLParamsUse = 6433,
        OpSDSLMixinUse = 6434,
        OpSDSLMixinChild = 6435,
        OpSDSLMixinClone = 6436,
        OpSDSLParams = 6437,
        OpSDSLParamsField = 6438,
        OpSDSLConditionalStart = 6439,
        OpSDSLConditionalEnd = 6440,
        OpSDSLParamsTrue = 6441,
        OpSDSLElse = 6442,
        OpSDSLComposition = 6443,
        OpSDSLCompositionEnd = 6444,
        OpSDSLMixinInherit = 6445,
        OpSDSLCompose = 6446,
        OpSDSLStage = 6447,
        OpSDSLImportShader = 6448,
        OpSDSLImportFunction = 6449,
        OpSDSLImportVariable = 6450,
        OpSDSLImportStruct = 6451,
        OpVariableSDSL = 6452,
        OpMemberAccessSDSL = 6453,
        OpTypeFunctionSDSL = 6454,
        OpSDSLFunctionInfo = 6455,
        OpBaseSDSL = 6456,
        OpThisSDSL = 6457,
        OpStageSDSL = 6458,
        OpStreamsSDSL = 6459,
        OpSDSLMixin = 6460,
        OpSDSLMixinCompose = 6461,
        OpSDSLMixinComposeArray = 6462,
        OpSDSLGenericParameter = 6463,
        OpSDSLGenericReference = 6464,
        OpConstantStringSDSL = 6465,
        OpTypeGenericSDSL = 6466,
        OpTypeStreamsSDSL = 6467,
        OpTypeGeometryStreamOutputSDSL = 6468,
        OpTypePatchSDSL = 6469,
        OpForeachSDSL = 6470,
        OpForeachEndSDSL = 6471,
        OpUnresolvableShaderSDSL = 6472,
        OpEmitVertexSDSL = 6473,
        OpNop = 0,
        OpUndef = 1,
        OpSourceContinued = 2,
        OpSource = 3,
