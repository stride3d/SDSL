...
public partial class InstructionInfo
{
    static InstructionInfo()
    {
        ...
        Instance.Register(SDSLOp.OpTypeFloat, OperandKind.FPEncoding, OperandQuantifier.ZeroOrOne, "floating point encoding", "Type-Declaration");
        ...
        Instance.Register(SDSLOp.OpUntypedVariableKHR, OperandKind.IdRef, OperandQuantifier.ZeroOrOne, "data type", "Memory");
        ...
        Instance.Register(SDSLOp.OpUntypedPrefetchKHR, OperandKind.IdRef, OperandQuantifier.ZeroOrOne, "cache type", "Memory");
        ...
        Instance.Register(SDSLOp.OpSDot, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotKHR, OperandKind.IdResultType, OperandQuantifier.One, "resultType", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotKHR, OperandKind.IdResult, OperandQuantifier.One, "resultId", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotKHR, OperandKind.IdRef, OperandQuantifier.One, "vector1", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotKHR, OperandKind.IdRef, OperandQuantifier.One, "vector2", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotKHR, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        ...
        Instance.Register(SDSLOp.OpUDot, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotKHR, OperandKind.IdResultType, OperandQuantifier.One, "resultType", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotKHR, OperandKind.IdResult, OperandQuantifier.One, "resultId", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotKHR, OperandKind.IdRef, OperandQuantifier.One, "vector1", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotKHR, OperandKind.IdRef, OperandQuantifier.One, "vector2", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotKHR, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        ...
        Instance.Register(SDSLOp.OpSUDot, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotKHR, OperandKind.IdResultType, OperandQuantifier.One, "resultType", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotKHR, OperandKind.IdResult, OperandQuantifier.One, "resultId", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotKHR, OperandKind.IdRef, OperandQuantifier.One, "vector1", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotKHR, OperandKind.IdRef, OperandQuantifier.One, "vector2", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotKHR, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        ...
        Instance.Register(SDSLOp.OpSDotAccSat, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotAccSatKHR, OperandKind.IdResultType, OperandQuantifier.One, "resultType", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotAccSatKHR, OperandKind.IdResult, OperandQuantifier.One, "resultId", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotAccSatKHR, OperandKind.IdRef, OperandQuantifier.One, "vector1", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotAccSatKHR, OperandKind.IdRef, OperandQuantifier.One, "vector2", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotAccSatKHR, OperandKind.IdRef, OperandQuantifier.One, "accumulator", "Arithmetic");
        Instance.Register(SDSLOp.OpSDotAccSatKHR, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        ...
        Instance.Register(SDSLOp.OpUDotAccSat, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotAccSatKHR, OperandKind.IdResultType, OperandQuantifier.One, "resultType", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotAccSatKHR, OperandKind.IdResult, OperandQuantifier.One, "resultId", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotAccSatKHR, OperandKind.IdRef, OperandQuantifier.One, "vector1", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotAccSatKHR, OperandKind.IdRef, OperandQuantifier.One, "vector2", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotAccSatKHR, OperandKind.IdRef, OperandQuantifier.One, "accumulator", "Arithmetic");
        Instance.Register(SDSLOp.OpUDotAccSatKHR, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        ...
        Instance.Register(SDSLOp.OpSUDotAccSat, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotAccSatKHR, OperandKind.IdResultType, OperandQuantifier.One, "resultType", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotAccSatKHR, OperandKind.IdResult, OperandQuantifier.One, "resultId", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotAccSatKHR, OperandKind.IdRef, OperandQuantifier.One, "vector1", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotAccSatKHR, OperandKind.IdRef, OperandQuantifier.One, "vector2", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotAccSatKHR, OperandKind.IdRef, OperandQuantifier.One, "accumulator", "Arithmetic");
        Instance.Register(SDSLOp.OpSUDotAccSatKHR, OperandKind.PackedVectorFormat, OperandQuantifier.ZeroOrOne, "packed vector format", "Arithmetic");
        ...
        Instance.Register(SDSLOp.OpCooperativeMatrixLoadKHR, OperandKind.MemoryAccess, OperandQuantifier.ZeroOrOne, "memory operand", "Memory");
        ...
        Instance.Register(SDSLOp.OpCooperativeMatrixStoreKHR, OperandKind.MemoryAccess, OperandQuantifier.ZeroOrOne, "memory operand", "Memory");
        ...
        Instance.Register(SDSLOp.OpCooperativeMatrixMulAddKHR, OperandKind.CooperativeMatrixOperands, OperandQuantifier.ZeroOrOne, "cooperative matrix operands", "Arithmetic");
        ...
        Instance.Register(SDSLOp.OpFinalizeNodePayloadsAMDX, OperandKind.IdRef, OperandQuantifier.One, "payloadArray", "Reserved");
        ...
        Instance.Register(SDSLOp.OpInitializeNodePayloadsAMDX, OperandKind.IdRef, OperandQuantifier.One, "payloadArray", "Reserved");
        Instance.Register(SDSLOp.OpInitializeNodePayloadsAMDX, OperandKind.IdScope, OperandQuantifier.One, "visibility", "Reserved");
        Instance.Register(SDSLOp.OpInitializeNodePayloadsAMDX, OperandKind.IdRef, OperandQuantifier.One, "payloadCount", "Reserved");
        Instance.Register(SDSLOp.OpInitializeNodePayloadsAMDX, OperandKind.IdRef, OperandQuantifier.One, "nodeIndex", "Reserved");
        ...
        Instance.Register(SDSLOp.OpReportIntersectionNV, OperandKind.IdResultType, OperandQuantifier.One, "resultType", "Reserved");
        Instance.Register(SDSLOp.OpReportIntersectionNV, OperandKind.IdResult, OperandQuantifier.One, "resultId", "Reserved");
        Instance.Register(SDSLOp.OpReportIntersectionNV, OperandKind.IdRef, OperandQuantifier.One, "hit", "Reserved");
        Instance.Register(SDSLOp.OpReportIntersectionNV, OperandKind.IdRef, OperandQuantifier.One, "hitKind", "Reserved");
        ...
        Instance.Register(SDSLOp.OpTypeAccelerationStructureNV, OperandKind.IdResult, OperandQuantifier.One, "resultId", "Type-Declaration");
        ...
        Instance.Register(SDSLOp.OpDemoteToHelperInvocationEXT, OperandKind.None, null, "Debug");
        ...
        Instance.Register(SDSLOp.OpDecorateStringGOOGLE, OperandKind.IdRef, OperandQuantifier.One, "target", "Annotation");
        Instance.Register(SDSLOp.OpDecorateStringGOOGLE, OperandKind.Decoration, OperandQuantifier.One, "decoration", "Annotation");
        ...
        Instance.Register(SDSLOp.OpMemberDecorateStringGOOGLE, OperandKind.IdRef, OperandQuantifier.One, "structType", "Annotation");
        Instance.Register(SDSLOp.OpMemberDecorateStringGOOGLE, OperandKind.LiteralInteger, OperandQuantifier.One, "member", "Annotation");
        Instance.Register(SDSLOp.OpMemberDecorateStringGOOGLE, OperandKind.Decoration, OperandQuantifier.One, "decoration", "Annotation");
